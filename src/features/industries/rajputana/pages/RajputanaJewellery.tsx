...
interface CollectionItem {
  ...
  name: string;
  tagline: string;
  image: string; // Dedicated jewellery image
  highlights: string[];
}
...
const JEWELLERY_COLLECTIONS: CollectionItem[] = [
  {
    ...
    image: '/media/industries/rajputana/jadau.png', // Uncut diamond polki set on green velvet
  ...
  },
  {
    ...
    image: '/media/industries/rajputana/meenakari.png', // Enamelled necklace on cream fabric
    highlights: ['Enamel Jewellery', 'Vibrant Handwork', 'Heritage Designs']
  }
];

export const RajputanaJewellery: React.FC = () => {
  const navigate = useNavigate();
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [selectedServiceName, setSelectedServiceName] = useState('Traditional Royal Jewellery Pairing');
  ...
  return (
    <MainLayout>
      <ShowcaseNavigation 
        ...
        showcaseName="Rajputana Jewellery" 
        accentColor="#C8A15A" 
        theme="light" 
      />
      <div 
      ...
      >
        ...
        <header className="border-b border-[#C8A15A]/25 py-5 px-6 bg-[#FAF6EE]">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div>
              <Button 
                onClick={() => openStylingWithService('Traditional Royal Jewellery Pairing', 'Header Private Viewing')}
        ...
        <div className="space-y-0">
          {JEWELLERY_COLLECTIONS.map((item, index) => {
                ...
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-10 items-stretch overflow-hidden">
                  ...
                  <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-14 bg-[#FAF6EE] text-[#222222] lg:col-span-3 border border-[#C8A15A]/25 lg:border-none">
                    <div className="space-y-2">
                      <span className="font-sans text-[8px] font-bold uppercase tracking-wider text-[#C8A15A]">Royal Kundan-Jadau</span>
                    ...
                    <div className="pt-8">
                      <Button 
                        onClick={() => openStylingWithService('Traditional Royal Jewellery Pairing', item.name)}
        ...
        <section className="bg-[#FAF6EE] border-t border-[#C8A15A]/30">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 divide-y divide-[#C8A15A]/25 sm:divide-y-0 sm:divide-x divide-x-0 divide-dashed sm:divide-solid">
            ...
            {/* Book Consultation */}
            <button 
              onClick={() => openStylingWithService('Traditional Royal Jewellery Pairing', 'Boutique Consultation')}
...
export default RajputanaJewellery;
